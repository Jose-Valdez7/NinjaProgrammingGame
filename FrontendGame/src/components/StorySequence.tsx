...
const storyParts = [
  "Había una vez un joven programador llamado Martín, Martín era un apasionado por los ninjas y le gustaba imaginar que era uno, un dia se propuso a hacer un juego hiperrealista, como Martín sabia programar no le tardo mas de unos 2 meses.",
  ...
  "El hace varios meses atras estaba programando un juego con realidad aumentada utilizando las gafas de realidad virtual, cuando Martín entro al codigo vio los errores mas facil y los corrigio sin ningun problema.",
  ...
  "Pero ¡Oh, sorpresa!, no podia salir del juego hasta que lo complete, aunque se veía un escenario espantoso, Martín estaba feliz ya que porfin cumpliria su sueño de ser ninja, pero el no sabia lo que le esperaba... En cuanto empezo el primer nivel no se podía mover, ya que necesitaba que alguien mas lo ayude.",
  "Entonces llamo a su mejor amigo de Internet MICHIHACKER, juntos deberan completar el juego para que Martín vuelva a la vida real."
];

const fullStory = `NINJA 404

Había una vez un joven programador llamado Martín, Martín era un apasionado por los ninjas y le gustaba imaginar que es un ninja, un dia se propuso a hacer un juego hiperrealista, como Martín sabia programar no le tardo mas de unos 2 meses, en cuanto probo el juego se dio cuenta que al momento de la ejecucion, tenia muchos bugs y errores, entonces se le ocurrio la maravillosa idea de entrar dentro del codigo, el hace varios meses atras estaba programando un juego con realidad aumentada utilizando las gafas de realidad virtual, cuando Martín entro al codigo vio los errores mas facil y los corrigio sin ningun problema, al momento de ejecutarlo se olvido que seguia con las gafas de realidad virtual puestas y lo ejecuto, vio que no habia ningun error y se propuso en probarlo al otro día, pero ¡Oh, sorpresa!, no podia salir del juego hasta que lo complete, aunque se veía un escenario espantoso, Martín estaba feliz ya que porfin cumpliria su sueño de ser ninja, pero el no sabia lo que le esperaba... En cuanto empezo el primer nivel no se podía mover, ya que necesitaba que alguien mas lo ayude, entonces llamo a su mejor amigo de Internet MICHIHACKER, juntos deberan completar el juego para que Martín vuelva a la vida real.`;
