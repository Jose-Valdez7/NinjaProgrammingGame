...
const storyParts = [
  "Había una vez un joven programador llamado JSON, JSON era un apasionado por los ninjas y le gustaba imaginar que era uno, un dia se propuso a hacer un juego hiperrealista, como JSON sabia programar no le tardo mas de unos 2 meses.",
  ...
  "El hace varios meses atras estaba programando un juego con realidad aumentada utilizando las gafas de realidad virtual, cuando JSON entro al codigo vio los errores mas facil y los corrigio sin ningun problema.",
  ...
  "Pero ¡Oh, sorpresa!, no podia salir del juego hasta que lo complete, aunque se veía un escenario espantoso, JSON estaba feliz ya que porfin cumpliria su sueño de ser ninja, pero el no sabia lo que le esperaba... En cuanto empezo el primer nivel no se podía mover, ya que necesitaba que alguien mas lo ayude.",
  "Entonces llamo a su mejor amigo de Internet MICHIHACKER, juntos deberan completar el juego para que JSON vuelva a la vida real."
];
